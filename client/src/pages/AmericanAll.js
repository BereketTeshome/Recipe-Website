...
const AmericanAll = () => {
    ...
    useEffect(() => {
        const fetchData = async() =>{
            setLoading(true)
            try {
                const res = await axios.get("https://recipe-website-three-rho.vercel.app/api/recipe/getAllAmericanRecipe")
...
<div className='allLatest'>
    ...
    <Box mb={'20px'}>
            <Breadcrumbs area-label='breadcrumb'>
              ...
              <Typography>All American Recipes</Typography>              
            </Breadcrumbs>
          </Box>
    <div className='allLatest_header'>
        <h2>All American Recipes</h2>
    </div>
