...
const ChineseAll = () => {
    ...
    useEffect(() => {
        const fetchData = async() =>{
            setLoading(true)
            try {
                const res = await axios.get("https://recipe-website-three-rho.vercel.app/api/recipe/getAllChineseRecipe")
...
<div className='allLatest'>
    ...
    <Box mb={'20px'}>
            <Breadcrumbs area-label='breadcrumb'>
              ...
              <Typography>All Chinese Recipes</Typography>              
            </Breadcrumbs>
          </Box>
    <div className='allLatest_header'>
        <h2>All Chinese Recipes</h2>
    </div>
